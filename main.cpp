...
int main(int argc, char** argv){
    ...
    set_wave_handle(output_format, wav_fmt.fmt_id, wav_fmt.ch, wav_fmt.sampling_rate, wav_fmt.bit_depth, 0);

    //出力デバイスのハンドル
    HWAVEOUT output_handle = NULL;
    //出力デバイスのハンドルを取得する
    MMRESULT result = waveOutOpen(&output_handle, WAVE_MAPPER, &output_format, (DWORD_PTR)(NULL), 0, CALLBACK_NULL);
